...
public class WebTable {
	...
	public static void main(String[] args) {
		...
		String text = driver.findElement(By.xpath("//div[@class='ui-datatable-scrollable-body']/table/tbody/tr/td"))
				.getText();
		System.out.println("1st row and col value :" + text);

		String text2 = driver
				.findElement(By.xpath("//div[@class='ui-datatable-scrollable-body']/table/tbody/tr[3]/td[2]"))
				.getText();
		System.out.println("data 3rd row and 2nd col :" + text2);

		// find no of rows
		List<WebElement> rowValue = driver
		...
		// find no of col
		List<WebElement> colValue = driver
